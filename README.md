...
```powershell
C:\Windows\Microsoft.NET\Framework\v4.0.30319\csc.exe /nologo /target:exe /platform:x86 /out:StarcraftMapUnprotector.exe /reference:TkMPQLib.dll Program.cs MpqExtractor.cs ChkParser.cs ChkNormalizer.cs TerrainRepairer.cs
