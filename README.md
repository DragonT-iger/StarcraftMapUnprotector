...
이 도구는 ScmDraft 2 기준으로 맵을 열고 편집할 수 있게 만드는 것을 목표로 합니다. 변환된 맵이 StarCraft에서 정상적으로 실행되는 것을 보장하지는 않습니다. 특히 EUD 맵은 편집기에서 열 수 있더라도 게임 실행이 실패하거나 동작이 깨지는 경우가 많습니다.
