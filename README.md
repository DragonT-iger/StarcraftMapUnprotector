...
이 프로젝트는 의도적으로 오픈소스로 공개했습니다. 기존에 만들어졌지만 더 이상 관리되지 않거나 열어볼 수 없게 된 StarCraft 맵들을 다시 확인하고, 필요한 경우 수정해 유용하게 활용할 수 있도록 돕는 것이 목적입니다.

맵 제작자의 권리와 원본 저작물을 존중하는 선에서, 오래된 맵 자료를 보존하고 복구하는 데 도움이 되는 도구가 되기를 바랍니다.
...
변환 결과는 ScmDraft 2에서 확인하는 것을 기준으로 합니다. 다른 편집기에서는 일부 데이터가 다르게 보이거나 열리지 않을 수 있습니다.
...
ScmDraft 2에서 열 수 있는 정보 복구를 우선하므로, 원본 보호 구조나 게임 실행에 필요한 특수 동작 정보가 일부 달라질 수 있습니다.
